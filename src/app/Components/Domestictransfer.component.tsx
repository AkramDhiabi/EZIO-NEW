...
import Entertransferdetails from './Entertransferdetails.component';
...
class Domestictransfer extends React.Component<any, any> {
    constructor(props) {
        super(props);
                    ...
                    <Grid.Row>
                        ...
                        <Grid.Column id="ttitle" width={14}>
                            <Segment id="Summarybox">
                                <span className="accst">Domestic transfer</span>
...
export default withRouter(connect(mapStateToProps, matchDispatchToProps)(Domestictransfer));