...
class AccordionExampleStandard extends React.Component < any > {
    state = {
        activeIndex: 0
    }
        ...
        return (
            <Accordion>
                ...
                <Accordion.Content
                    ...
                    {store
                        .getState()
                        .ReportBackend == false && <a className="item isDisabled">Demo configuration</a >
}
                    {store
                        .getState()
                ...
                <Accordion.Title
                    ...
                    to='/qrtoken'
                    index={10}
                    onClick={(e) => window.location.href = '/qr'}>
                    <Icon name='dropdown'/>
                    Enroll device
                </Accordion.Title>
...
export default withRouter(connect(mapStateToProps, matchDispatchToProps)(AccordionExampleStandard));
