...
function draw_qrcode(text, version, ECL) {
    ...
    var qrCode = "<table style='border-width: 0px; border-style: none; border-color: #0000ff; border-collapse: collapse;'>";
    ...
    qrCode += "</table>";
    document.getElementById("qr-code-div-id").innerHTML = qrCode;
